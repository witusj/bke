...
Het voordeel hierbij is, dat we met continuous assessment in veel kortere tijd PDCA-iteraties kunnen doorlopen. Voor een optimale werking is het echter belangrijk dat op het gebied van toetsing een formeel kwaliteitssyteem wordt afgesproken en dat aandachtspunten en verbeteringen centraal worden gedeeld.

...
Tijdens het schrijven van dit portfolio ontdekte ik een aantal zaken die in volgende iteraties aandacht verdienen.
...
Het voordeel hierbij is, dat we met continuous assessment in veel kortere tijd PDCA-iteraties kunnen doorlopen. Voor een optimale werking is het echter belangrijk dat op het gebied van toetsing eerst een formeel kwaliteitssyteem wordt afgesproken en dat aandachtspunten en verbeteringen centraal worden gedeeld.

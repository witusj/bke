...
* Zodat er een kennisfundament op basis waarvan is waarop complexe beslissingen kunnen worden genomen in de nabije toekomst, zoals in probleemgestuurd onderwijs

De onderwerpen die bij MSI aan bod komen gaan over technologieën die nog niet mainstream zijn, in ieder geval niet bij het MKB. Tevens wordt verwacht dat studenten na het voltooien van de Minor goed geïnformeerd zijn over de keuzes die gemaakt kunnen worden en welke afwegingen hierbij horen. Dit
